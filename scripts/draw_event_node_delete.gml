/// void draw_event_node_delete(x, y, DataEventNode);
...
var tolerance=8;
if (mouse_within_rectangle(argument0-tolerance, argument1-tolerance, argument0+tolerance, argument1+tolerance)){
