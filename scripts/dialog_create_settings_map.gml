...
yy=yy+32;
var el_name=create_input(16, yy, "Name: ", ew, eh, uivc_settings_map_name, "name", ActiveMap.name, 1, validate_string, ui_value_string, 0, 0, 32, vx1, vy1, vx2, vy2, dg);
yy=yy+32;
var el_name_internal=create_input(16, yy, "Internal name: ", ew, eh, uivc_settings_map_internal, "name-internal", ActiveMap.internal_name, 1, validate_string, ui_value_string, 0, 0, 32, vx1, vy1, vx2, vy2, dg);
...
var el_summary=create_input(16, yy, "Summary: ", ew, eh_long, uivc_settings_map_summary, "summary", ActiveMap.summary, 1, validate_string, ui_value_string, 0, 0, 400, vx1, vy1, vx2, vy2, dg);
