/// void dialog_create_data_enum_select(Dialog);
...
el_confirm=create_button(dw/2-b_width/2, dh-32-b_height/2, "Done", b_width, b_height, fa_center, dc_data_property_set_enum, dg);
