...
var el_cmd_move_random=create_button(c2+16, yy, "Move Randomly", ew, eh, fa_center, omu_mr_move_random, dg);
yy=yy+el_cmd_move_random.height+spacing2;
var el_cmd_move_towards=create_button(c2+16, yy, "Move Towards Player", ew, eh, fa_center, omu_mr_move_towards_player, dg);
yy=yy+el_cmd_move_towards.height+spacing2;
var el_cmd_move_away=create_button(c2+16, yy, "Move Away from Player", ew, eh, fa_center, omu_mr_move_away_player, dg);
yy=yy+el_cmd_move_away.height+spacing2;
var el_cmd_move_forward=create_button(c2+16, yy, "Move Forward", ew, eh, fa_center, omu_mr_move_forward, dg);
yy=yy+el_cmd_move_forward.height+spacing2;
var el_cmd_move_backward=create_button(c2+16, yy, "Move Back", ew, eh, fa_center, omu_mr_move_backward, dg);
