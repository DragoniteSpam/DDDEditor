...
var el_name=create_input(16, yy, "Name:", ew, eh, null, "", page.name, "Name of the event", validate_string, ui_value_string, 0, 1, 16, vx1-64, vy1, vx2, vy2, dg);
yy=yy+eh+spacing;
var el_enabled=create_checkbox(16, yy, "Enabled", ew, eh, null, "", page.enabled, dg);
yy=yy+eh+spacing;
var el_condition=create_text(16, yy, "Conditions", ew, eh, fa_left, ew, dg);
yy=yy+eh+spacing;

var el_condition_switch_global_enabled=create_checkbox(16, yy, "", ucheck_width, eh, null, "", page.condition_switch_global_enabled, dg);
...
var el_condition_variable_global_enabled=create_checkbox(16, yy, "", ucheck_width, eh, null, "", page.condition_variable_global_enabled, dg);
var el_condition_variable_global=create_button(16+64, yy, "Global Variable", ew-64, eh, fa_center, null, dg);
yy=yy+eh+spacing;

var el_condition_switch_self_enabled=create_checkbox(16, yy, "", ucheck_width, eh, null, "", page.condition_switch_self_enabled, dg);
var el_condition_switch_self=create_button(16+64, yy, "Self Switch", ew-64, eh, fa_center, null, dg);
yy=yy+eh+spacing;
// variable properties go in the form that pops up when you click the button
var el_condition_variable_self_enabled=create_checkbox(16, yy, "", ucheck_width, eh, null, "", page.condition_variable_self_enabled, dg);
var el_condition_variable_self=create_button(16+64, yy, "Self Variable", ew-64, eh, fa_center, null, dg);
yy=yy+eh+spacing;

var el_condition_item_enabled=create_checkbox(16, yy, "", ucheck_width, eh, null, "", page.condition_item_enabled, dg);
var el_condition_item=create_button(16+64, yy, "Posseses Item", ew-64, eh, fa_center, null, dg);
yy=yy+eh+spacing;
var el_condition_code_enabled=create_checkbox(16, yy, "", ucheck_width, eh, null, "", page.condition_code_enabled, dg);
...
yy=yy+eh+spacing;
var el_option_movement=create_checkbox(16, yy, "Animate Movement", ew, eh, null, "", page.option_animate_movement, dg);
el_option_movement.interactive=!entity.static;
yy=yy+eh+spacing;
var el_option_idle=create_checkbox(16, yy, "Animate Idle", ew, eh, null, "", page.option_animate_idle, dg);
yy=yy+eh+spacing;
var el_option_direction_fix=create_checkbox(16, yy, "Direction Fix", ew, eh, null, "", page.option_direction_fix, dg);

var yy=64;

var el_trigger=create_radio_array(c2+16, yy, "Trigger Method", ew, eh, null, page.trigger, dg);
...
var el_movement=create_radio_array(c2+16, yy, "Autonomous Movement", ew, eh, null, page.autonomous_movement, dg);
...
var el_movement_speed=create_input(c2+16, yy, "Move Speed:", ew, eh, null, "", page.autonomous_movement_speed, "0 (slowest) - 5", validate_int, ui_value_real, 0, 5, 1, vx1+16, vy1, vx2, vy2, dg);
el_movement_speed.interactive=!entity.static;
yy=yy+eh+spacing;
var el_movement_frequency=create_input(c2+16, yy, "Move Frequency:", ew, eh, null, "", page.autonomous_movement_speed, "0 (slowest) - 4", validate_int, ui_value_real, 0, 4, 1, vx1+16, vy1, vx2, vy2, dg);
