/// void dialog_create_add_custom_node(Dialog);

var dw=320;
var dh=640;

// todo cache the custom event and only commit the changes when you're done
var dg=dialog_create(dw, dh, "Custom Nodes", dialog_default, dc_close_no_questions_asked, argument0);
...
el_confirm=create_button(dw/2-b_width/2, dh-32-b_height/2, "Done", b_width, b_height, fa_center, omu_event_add_custom, dg);
