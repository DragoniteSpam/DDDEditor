...
for (var i=argument0.tile_view_x; i<argument0.tile_view_x+argument0.width; i=i+Stuff.tile_size){
    draw_line_colour(argument0.x+i-argument0.tile_view_x, argument0.y,
        argument0.x+i-argument0.tile_view_x, argument0.y+argument0.height, c_blue, c_blue);
}

for (var i=argument0.tile_view_y; i<argument0.tile_view_y+argument0.height; i=i+Stuff.tile_size){
    draw_line_colour(argument0.x, argument0.y+i-argument0.tile_view_y,
        argument0.x+argument0.width, argument0.y+i-argument0.tile_view_y, c_blue, c_blue);
}

draw_rectangle_colour(argument0.x, argument0.y, argument0.x+argument0.width-1,
    argument0.y+argument0.height-1, c_black, c_black, c_black, c_black, true);
