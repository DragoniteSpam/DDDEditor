...
var el_bezier=create_input(dw/2+16, 64, "Bezier precision: ", ew, eh, uivc_bezier_precision, "", Stuff.setting_bezier_precision, Stuff.setting_bezier_precision,
...
ds_list_add(dg.contents, el_width, el_height, el_depth, el_dummy, el_bezier, el_confirm);
